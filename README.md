...
During the next four weeks, what improvement do you plan in your code-quality practice? (in your regular work, not in this repository!)Implemented code should be easly adaptable to new features.
